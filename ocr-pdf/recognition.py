...
def analyze_layout():
    # sample document
    #formUrl = r"C:/Users/ariel/Documents/Projects/agent_framework/PLATAFORMAS ELECTORALES/BA/BA318_2488-2-318. LIBER.AR.pdf"
    ...
    poller = document_intelligence_client.begin_analyze_document(
        "prebuilt-document", AnalyzeDocumentRequest(url_source=formUrl
    ))
